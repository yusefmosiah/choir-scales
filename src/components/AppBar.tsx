    ...
    <div className="flex flex-row h-20 bg-gray-900 border-b border-gray-800 shadow-lg navbar md:mb-2 text-neutral-content">
      <div className="navbar-start align-items-center">
        <div className="hidden ml-10 sm:inline w-22 h-22 md:p-2">
          <Link href="/" className="font-mono text-2xl font-bold text-cyan-500 hover:text-cyan-400">
            CHOIR
          </Link>
        </div>
      </div>
      ...
      <div className="navbar-end">
        ...
        <div className="dropdown dropdown-end">
          <label tabIndex={0} className="text-cyan-500 btn btn-square btn-ghost">
          ...
          <ul tabIndex={0} className="p-2 w-52 bg-gray-800 shadow menu dropdown-content rounded-box">
            <li>
              <div className="form-control">
                <label className="cursor-pointer label">
                  <a>Autoconnect</a>
                  <input type="checkbox" checked={autoConnect} onChange={(e) => setAutoConnect(e.target.checked)} className="toggle toggle-sm toggle-cyan" />
                </label>
              </div>
            </li>
            <li>
